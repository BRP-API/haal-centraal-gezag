...
Functionaliteit: Persoon, Inschrijving, Verblijfplaats gegeven stap definities
  ...
  Abstract Scenario: '[aanduiding kind]' is geadopteerd door '[aanduiding ouder]' als ouder [1 of 2]
    ...
    Dan zijn de gegenereerde SQL statements
      ...
      |            | persoon            | INSERT INTO public.lo3_pl_persoon(pl_id,stapel_nr,volg_nr,persoon_type,burger_service_nr,geboorte_land_code,akte_nr,geslachts_naam) VALUES($1,$2,$3,$4,$5,$6,$7,$8) |               10000,0,1,P,000000024,6030,1AA0100,P2 |
